...
const editPatient = () => {
  ...
  ApiClient('multipart/formdata')
    .patch(`patients/${patient.value.id}/`, data)
    .then(() => {
...
emitter.on('editPatient', (data) => {
  patient.value = data.patient
  imageSrc.value = data.patient.image
  openModal()
})
</script>
                ...
                <div class="mt-5 text-main">
                  <div class="flex gap-5 items-center">
                    ...
                    <div class="text-sm">
                      ...
                      <p class="text-main-100">
                        An image of the patient to be added in the system.
                      </p>
                    </div>
                  </div>
